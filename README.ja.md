...
<a href="https://github.com/haruhiyuki/DesignCode/releases/latest"><img src="https://img.shields.io/github/v/release/haruhiyuki/DesignCode?label=release&color=blue" alt="version" /></a>
...
7. Codex、Claude Code、OpenCodeに対応。
...
DesignCodeの利用にはAgentバックエンドが必要で、Codex、OpenCodeが内蔵されています。任意のモデルのAPIキーを取得してOpenCodeで使用するか、サブスクリプションを通じてCodexを利用できます。
